...
### Wav
* 만일 KEMDy19 중 wav폴더 내 .wav파일들을 하나의 폴더로 취합하는 과정에서 실행시간이 오래 걸리는 경우, readme상단의 다운로드 링크를 통해 merged_wav_folder를 사용할 것을 권장함
...
파일을 생성하는 부분에서 상대적으로 장시간이 소요되는 경우, 우리가 이미 실행시켜 놓은 파일이 readme 상단에 다운로드 링크에 있으므로 그것을 활용하기 권장함
